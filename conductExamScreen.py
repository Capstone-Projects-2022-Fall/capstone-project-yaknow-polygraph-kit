...
def make_window():
    ...
    window = gui.Window('yaKnow - PolyGraph Exam', layout, size=(1500, 900), icon=icon, finalize=True)
...
##### WE CAN CHANGE AVERAGE TO THIS IF WE DONT WANT TO USE SKIN CONDUCTIVITY DATA IF IT IS TOO BAD
    # average1 = (conductExamScreen.zTest1Respiration[1])
    ...
    layout = [
              ...
              [gui.Text('3rd baseline average: %s' % str(average3))],
...
def showRespirationProbabilityDistribution(question):
    ...
    graph1.text(0.5, 0.25, 'Ztest: results(%s)' % conductExamScreen.zTest2Respiration, horizontalalignment='center',
                verticalalignment='center',
