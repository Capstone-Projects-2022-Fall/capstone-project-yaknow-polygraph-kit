...
for x in range(0, 4):
    store_other_mysql.drop_table("Respiration"+str(x))
    store_other_mysql.drop_table("BP"+str(x))
    store_other_mysql.drop_table("Pulse"+str(x))
    store_other_mysql.drop_table("GSR"+str(x))
